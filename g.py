...
TOKEN = '7292111189:AAHWFV_vIG1Y81rX011nNFPDcjZWtFh1Qus'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002200678079      # enter the log channel id
CHANNEL_ID = -1002200678079               # enter the log channel id
error_channel_id = -1002200678079          # enter the log channel id
